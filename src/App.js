...
function App() {
  ...
  const [breed, setBreed]= useState('retriever');
  ...
  return (
    <div className="App">
      ...
      <h2>Choose an option below and see a Picture</h2>
    <select>
      <option defaultValue={Selection} value="">Choose A Breed</option>
      ...
      <option value="chihuahua">chihuahua</option><option value="chow">chow</option>
      ...
      <option value="pug">pug</option><option value="puggle">puggle</option>
      ...
      <DogImage dogUrl={dogUrl} breed={breed} />
    </div>
